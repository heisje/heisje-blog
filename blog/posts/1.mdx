...
<details>
<summary>이것은 접을 수 있는 섹션의 제목입니다</summary>

여기에 세부 내용이 들어갑니다. 이 부분은 사용자가 `<summary>` 태그를 클릭할 때 보이게 됩니다.

- 목록 아이템 1
- 목록 아이템 2
- 목록 아이템 3

또한 **볼드체**, *이탤릭체*, 그리고 [링크](#) 같은 마크다운 포맷팅을 세부 내용 안에서 자유롭게 사용할 수 있습니다.
...
The best price was <del>$199.99</del> <ins>$149.99</ins>.
...
This is regular text - <small>and this is smaller text.</small>
H<sub>2</sub>O is the chemical formula for water.
The area of the square is 15m<sup>2</sup>.



[이것은 링크 텍스트입니다](http://www.example.com)
[이것은 링크 텍스트입니다](http://www.example.com)
